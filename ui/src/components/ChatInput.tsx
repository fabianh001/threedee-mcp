...
export const ChatInput: React.FunctionComponent<ChatInputProps> = ({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-4 fixed bottom-0 left-0 right-0">
      <div className="rounded-full border bg-white shadow-sm px-3 py-2 flex items-center gap-2">
        <input
          ref={inputRef}
          type="text"
